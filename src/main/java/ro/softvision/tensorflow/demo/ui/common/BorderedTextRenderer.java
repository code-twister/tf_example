...
package ro.softvision.tensorflow.demo.ui.common;
 ...
 */
public class BorderedTextRenderer {
   ...
   */
  public BorderedTextRenderer(final float textSize) {
   ...
   * @param textSize text size in pixels
   */
  public BorderedTextRenderer(final int interiorColor, final int exteriorColor, final float textSize) {
